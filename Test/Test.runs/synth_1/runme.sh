...
HD_PWD='D:/Programming_test/ComputerOrganization/Test/Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_SingleCycle.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_SingleCycle.tcl
