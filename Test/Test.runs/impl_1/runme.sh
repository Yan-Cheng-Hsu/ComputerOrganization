...
HD_PWD='D:/Programming_test/ComputerOrganization/Test/Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_SingleCycle.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_SingleCycle.tcl -notrace
