...
HD_PWD='D:/Programming_test/ComputerOrganization/PipelinedStructureTesting/PipelinedStructureTesting.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PipelinedStructure_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PipelinedStructure_tb.tcl
